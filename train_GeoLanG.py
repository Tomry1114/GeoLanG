...
def get_parser():
    ...
    parser.add_argument('--config',
                        # default='/lrs/projects/CROG/config/OCID-VLG/crog_multiple_r50.yaml',
                        default='/lrs/projects/CROG/config/OCID-VLG/crog_vit_b_16.yaml',
                        type=str,
                        help='config file')
